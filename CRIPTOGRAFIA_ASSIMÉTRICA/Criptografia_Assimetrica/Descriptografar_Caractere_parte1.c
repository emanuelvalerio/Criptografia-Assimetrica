...
#include<string.h>
#include<locale.h>
#include"../Descriptografar_Caractere_parte1.h"
...
void Descriptografar_Caractere_parte1()
{
    ...
    system("cls");
    char local[100];
    printf("\tDESCRIPTOGRAFAR ARQUIVO DE TEXTO DE SUBSTITUIÇÃO ALFABÉTICA  \n");
    ...
    while(strlen(local)==0) // verifica se o endereço onde o arquivo foi salvo foi digitado;
   {
    ...
    gets(chave_priv); // leitura da chave privada, para descriptografar;
 ...
 Descriptografar_Caractere_parte2(texto_criptografado); // passando o texto para a segunda etapa de descriptografia
